...
MeScroll.prototype.extendDownScroll = function(optDown) {
	MeScroll.extend(optDown, {
		...
		textOutOffset: 'release to fresh',
		textLoading: 'loading ...',
...
MeScroll.prototype.initDownScroll = function() {
	...
	if(!me.optDown.textColor && me.hasColor(me.optDown.bgColor)) me.optDown.textColor = "#fff";
...
MeScroll.prototype.touchmoveEvent = function(e) {
	...
	if (moveY > 0 && (
		...
		if (!me.inTouchend && !me.isDownScrolling && !me.optDown.isLock && (!me.isUpScrolling || (me.isUpScrolling &&
			...
			if(!me.startAngle) me.startAngle = me.getAngle(me.lastPoint, curPoint);
...
MeScroll.prototype.initUpScroll = function() {
	...
	if(!me.optUp.textColor && me.hasColor(me.optUp.bgColor)) me.optUp.textColor = "#fff";
